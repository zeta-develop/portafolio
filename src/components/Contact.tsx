              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4 p-4 rounded-lg hover:bg-card/50 transition-colors duration-300 cursor-pointer group">
                  ...
                  <div>
                    ...
                    <a href="mailto:ronaldadantellez@gmail.com" className="text-muted-foreground hover:text-primary transition-colors duration-300">
                      contacto@ronaldtellez.online
                    </a>
                  </div>
                </div>
