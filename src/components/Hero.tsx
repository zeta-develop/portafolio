    ...
    >
      <div className="container mx-auto z-10">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="mb-8 text-lg md:text-xl font-semibold text-primary animate-fade-in opacity-0" style={{ animationDelay: '0.2s', animationFillMode: 'forwards' }}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 glow-text animate-slide-up opacity-0" style={{ animationDelay: '0.6s', animationFillMode: 'forwards' }}>
            <TypewriterText
              text={`${t('hero.greeting')} ${profile.fullName}`}
              speed={80}
