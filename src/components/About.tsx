...
const About: React.FC = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="section-padding relative bg-muted/30" >
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mt-8 animate-on-scroll opacity-0">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-foreground">{t('about.degree1')}</h4>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-medium text-foreground">{t('about.degree2')}</h4>
            ...
            <div className="mt-8 animate-on-scroll opacity-0">
              <a href="https://github.com/zeta-develop" target="_blank" rel="noopener noreferrer" className="inline-flex items-center px-6 py-3 rounded-full bg-primary text-primary-foreground 
                          font-medium shadow-soft transition-all duration-300 hover:bg-primary/90 hover:shadow-soft-lg hover:translate-y-[-2px]">
          ...
          <div className="lg:w-1/2 animate-on-scroll opacity-0">
            <div className="relative">
              ...
              <div className="relative glass overflow-hidden rounded-2xl shadow-soft-lg">
                <img 
                ...
                {/* Floating badges */}
                <div className="absolute top-4 left-4 glass p-3 rounded-full shadow-soft">
                  <Code className="w-5 h-5 text-primary" />
                </div>
                
                <div className="absolute bottom-4 right-4 glass p-3 rounded-full shadow-soft">
                  <Briefcase className="w-5 h-5 text-accent" />
                </div>
                
                {/* Info card */}
                <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 glass px-6 py-4 rounded-xl shadow-soft-lg">
            ...
            {/* Experience Section */}
            <div className="mt-12 glass p-6 rounded-xl shadow-soft animate-on-scroll opacity-0">
              ...
              <div className="space-y-6">
                <div className="border-l-2 border-primary/30 pl-4 pb-1">
                  <h4 className="font-medium text-foreground">{t('about.jobTitle1')}</h4>
                  <p className="text-sm text-muted-foreground mb-1">{t('about.jobCompany1')} • {t('about.jobPeriod1')}</p>
                  <p className="text-sm text-muted-foreground">{t('about.jobDescription1')}</p>
                </div>
              </div>
            </div>
          </div>
